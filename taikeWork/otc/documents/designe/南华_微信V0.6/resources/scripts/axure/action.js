                    ...
                    _addAnimation(elementId, queueTypes.setState, function() {
                        ...
                        if(stateInfo.setStateType == "value") {
                            ...
                            if(!stateNameFound) {
                                ...
                                // Wasn't a state name or number, so result
...
//                $ax.event.raiseSyntheticEvent(elementId, "onMove");
    ...
    //    result { oldWidth: oldWidth, oldHeight: oldHeight, newWidth: size.width, newHeight: size.height, change: oldWidth != size.width || oldHeight != size.height };
    //}
