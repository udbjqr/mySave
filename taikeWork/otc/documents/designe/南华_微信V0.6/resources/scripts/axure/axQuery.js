   ...
   $axure.resize = function(fn) { 
    ...
    $ax.public.fn.getParents = function (deep, filter) {
        ...
        var getParent = function(elementId) {
            ...
            // if repeater item, then just result repeater
            ...
            if (parentRepeater == scriptId) {
                // If you are repeater item, result your repeater
            ...
            // if state, then just result panel
            ...
            // If at top or parent type is desired, then result parent, otherwise keep climbing
