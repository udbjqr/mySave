...
$axure.internal(function($ax) {
    ...
    //    result !$ax.public.fn.IsReferenceDiagramObject(type) && !$ax.public.fn.IsLayer(type);
    //}
...
//        var y = JSON.stringify(axEventObject);
    ...
    _event.layerMapFocus = function(layer, elementId) {
        ...
        // If first child non existant result
        if (!mainObj) return;
    ...
    var _initializeObjectEvents = function(query, allowItem) {
        ...
        query.each(function(dObj, elementId) {
            ...
            //            result $ax.public.fn.IsVector(obj.type) && $ax.public.fn.IsTreeNodeObject(obj.parent.type) &&
    ...
    var _addEvent = function (target, eventType, handler, useCapture) {
        //this result value is only for debug purpose
