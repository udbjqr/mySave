...
//        }
    ...
    var _applySuffixToElementId = function(id, suffix) {
        return id + suffix;
        //        result _createElementId(_getScriptIdFromElementId(id) + suffix, _getItemIdFromElementId(id));
    };
    ...
    //        if(itemCount == 0) result { width: 0, height: 0 };
...
$axure.internal(function($ax) {
    ...
    _dynamicPanelManager.updatePanelContentPercentWidth = function(elementId) {
        //        if(_isPercentWidthPanel($obj(elementId))) result;
