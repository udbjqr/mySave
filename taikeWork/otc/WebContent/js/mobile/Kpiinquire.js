...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Kpicheck = __webpack_require__(93);

	var _Kpicheck2 = _interopRequireDefault(_Kpicheck);
	...
	var Kpicheckmain = _react2.default.createClass({
	  displayName: 'Kpicheckmain',
	  ...
	  render: function render() {
	    ...
	    if (this.state.Kpishowtype == "Kpiinquire" || this.state.Kpishowtype == "") {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(Kpiinquire, null)
	      );
	    }
	    if (this.state.Kpishowtype == "Kpicheck") {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Kpicheck2.default, null)
	      );
	    } else {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'toleft', onTouchEnd: this.torefs },
	            ' ',
	            _react2.default.createElement('a', { href: "javascript:void(0)" })
	          ),
	          'KPI\u8003\u6838'
	        ),
	        _react2.default.createElement('div', { dangerouslySetInnerHTML: createMarkup(errotext) })
	      );
	    }
	  }
	...
	//显示kpi考核列表
	var Kpiinquire = _react2.default.createClass({
	  displayName: 'Kpiinquire',
	  ...
	  toreferrers: function toreferrers() {
	    var $this = this;
	    setTimeout(function () {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { className: 'toleft', onTouchEnd: this.toreferrers },
	          ' ',
	          _react2.default.createElement('a', { href: "javascript:void(0)" })
	        ),
	        'KPI\u8003\u6838'
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: "javascript:void(0)", className: 'profile_pading', onTouchEnd: this.tokpi },
	              _react2.default.createElement(
	                'dt',
	                null,
	                _react2.default.createElement('img', { src: "../images/mobile/7KPI.png" }),
	                'KPI\u8003\u6838'
	              )
	            )
	          )
	        ),
	        _react2.default.createElement(_userfooter2.default, { name: 'index' })
	      )
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Kpicheckmain, null), document.getElementById('conter'));
	...
	var Kpicheck = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: "KpicheckCont" },
	                React.createElement(
	                    "div",
	                    { className: "totalscore  white" },
	                    React.createElement("div", { id: "myStat4", "data-dimension": "14", "data-text": htmlval, "data-info": "New Clients", "data-width": "4", "data-fontsize": "3", "data-percent": this.state.Totalscore, "data-fgcolor": "#61a9dc", "data-bgcolor": "#eee" })
	                ),
	                React.createElement(
	                    "div",
	                    { className: "talscorelegend  white" },
	                    React.createElement(
	                        "p",
	                        null,
	                        "*\u9500\u552E\u603B\u989D\u5206\u503C\u536040%"
	                ...
	                React.createElement(
	                    "div",
	                    { className: "totalscoreList white", ref: "totalscoreList", id: "totalscoreList" },
	                    React.createElement(
	                        "h2",
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "totalscoreCont" },
	                        React.createElement(
	                            "div",
	                            { className: "totalscoreL" },
	                            React.createElement(
	                                "p",
	                                null,
	                                React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "totalscoreR" },
	                            React.createElement("div", { id: "myStat1", "data-dimension": "6.5", "data-text": htmlval1, "data-info": "New Clients", "data-width": "2", "data-fontsize": "1", "data-percent": "75", "data-fgcolor": "#09B23B", "data-bgcolor": "#eee" })
	                        )
	                    )
	                )
	            )
