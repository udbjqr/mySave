...
/***/ function(module, exports, __webpack_require__) {
	...
	var currturl = window.location.href; //获取当前url
	var Myinformation = _react2.default.createClass({
	    displayName: 'Myinformation',
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                'vip\u5BA2\u6237\u7BA1\u7406',
	                _react2.default.createElement('div', { className: 'addvip' })
	            ),
	            _react2.default.createElement(
	                'div',
	                { ref: 'content' },
	                _react2.default.createElement(Vipclientdata, { options: this.state.vipdata })
	            )
	        );
	    }
	});
	...
	/*列表*/
	var Vipclientdata = _react2.default.createClass({
	    displayName: 'Vipclientdata',

	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'vipclientmain' },
	            this.props.options.map(function (data, i) {
	                var birthdayStatus = data.birthdayStatus == "true" ? _react2.default.createElement(
	                    'ico',
	                    { className: 'birthdayico' },
	                    _react2.default.createElement('img', { src: '../images/mobile/birthday.png' })
	                ) : "";
	                return _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: "vipclientInfo.html?id=" + data.id, className: 'profile_pading' },
	                            _react2.default.createElement(
	                                'dt',
	                                null,
	                                _react2.default.createElement(
	...
	ReactDOM.render(_react2.default.createElement(Myinformation, null), document.getElementById('conter'));
