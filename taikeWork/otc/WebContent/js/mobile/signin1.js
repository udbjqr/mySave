...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uploadfiles = __webpack_require__(192);
	...
	var Signin = _react2.default.createClass({
	  ...
	  //点击显示坐标
	  clicksigin: function clicksigin() {
	  ...
	  //转百度地图
	  geoconv: function geoconv(x, y, ts) {
	    $.jsonp({
	  ...
	  option: function option(key, valueArr) {
	    ...
	    if (Array.isArray(valueArr) && valueArr.length != 0) {
	      ...
	      this.setState(_defineProperty({}, key, valArr.toString()));
	    } else {
	      this.setState(_defineProperty({}, key, ""));
	    }
	  },
	  //关键字搜索
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_uploadfiles2.default, {
	        even: this.option
	      }),
	      _react2.default.createElement('div', { className: 'signin_map', id: 'allmap' }),
	      _react2.default.createElement(
	        'div',
	        { className: 'to_signin' },
	        _react2.default.createElement(
	          'button',
	          { className: 'signin-btn', onTouchEnd: this.clicksigin, ref: 'Signinbtn' },
	          '\u663E\u793A\u5750\u6807'
	        ),
	        _react2.default.createElement(
	          'button',
	          { className: 'signin-btn', onTouchEnd: this.getpoints },
	          '\u91CD\u65B0\u5B9A\u4F4D'
	        ),
	        _react2.default.createElement(
	          'button',
	          { className: 'signin-btn', onTouchEnd: this.clearpoint, ref: 'Signinbtn' },
	          '\u6E05\u9664\u5750\u6807'
	        ),
	        _react2.default.createElement('div', { className: 'fn-hide1 ', id: 'hidemap' })
	      )
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Signin, null), document.getElementById('conter'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Uploadfiles = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {}, /* 点击上传  */
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement("div", { className: "Upload_files" }),
	            React.createElement(
	                "div",
	                { className: "Upload_btns" },
	                React.createElement("input", { type: "file", capture: "camera", accept: "image/*", id: "filephoto", name: "filephoto", onChange: this.changePhoto })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./uploadfiles.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./uploadfiles.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".Upload_photo {\r\n    height: auto;\r\n    min-height: 12rem;\r\n    padding-bottom: 2rem;\r\n    overflow: auto;\r\n    text-align: center;\r\n}\r\n.Upload_btns {\r\n    position: relative;\r\n    width: 8rem;\r\n    height: 6rem;\r\n    margin-top: 2.5rem;\r\n    background: url(\"/otc/images/mobile/28.png\") no-repeat 0 0;\r\n    background-size: 8rem auto;\r\n    margin-left: 2rem;\r\n    clear: both;\r\n}\r\n\r\n#filephoto {\r\n    width: 8rem;\r\n    height: 6rem;\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    bottom: 0;\r\n    right: 0;\r\n    opacity: 0;\r\n}", ""]);
