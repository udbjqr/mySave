	...
	var Purchase = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('div', { className: 'profile margint_1r ', ref: 'purchase_cont' })
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Purchase, null), document.getElementById('conter'));
