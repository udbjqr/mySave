...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stock = _react2.default.createClass({
	  ...
	  isYestoday: function isYestoday(Yestoday, thisday) {
	  ...
	  /* 获取图标和判断是否可以跳转和拖动 */
	  customerico: function customerico(str, flag, leaveShowtype) {
	  ...
	  data: function data(url, customer_type, hours, name, plan_id, mark_type, flag, leaveShowtype) {
	  ...
	  //获取初始数据
	  getinfo: function getinfo(currdate) {
	    var $this = this;
	  ...
	  ajaxclient: function ajaxclient() {
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('div', { className: 'profile', id: 'client', ref: 'client' }),
	      _react2.default.createElement(_userfooter2.default, { name: 'client' })
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Stock, null), document.getElementById('conter'));
