...
/***/ function(module, exports, __webpack_require__) {
	...
	var Addstock = _react2.default.createClass({
	  ...
	  showinfo: function showinfo(showtype, currentpage) {
	    var $this = this;
	  ...
	  */
	  ...
	  render: function render() {
	    ...
	    var add_text = this.state.isbefore ? "" : _react2.default.createElement(
	      'div',
	      { className: 'addStore white margint_1r', onTouchEnd: this.addstore },
	      _react2.default.createElement('i', { className: 'addico fa fa-plus' }),
	      '\u65B0\u589E\u62DC\u8BBF\u8BA1\u5212'
	    );
	    ...
	    if (canControl == "1") {
	      ...
	      canControlbtn = _react2.default.createElement(
	        'button',
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('div', { className: 'profile', id: 'addclient', ref: 'client' }),
	        add_text,
	        canControlbtn,
	        _react2.default.createElement('div', { id: 'addclentmain' })
	      )
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Addstock, null), document.getElementById('conter'));
