(function(a) {
    a.fn.circliful = function(b, d) {
        ...
        return this.each(function() {
            ...
            a(this).width(f.dimension + "rem");
            var wapwidth=a(this).width();
            
            var i = a("<canvas></canvas>").attr({
                width: wapwidth*0.98,
                height: wapwidth*0.98
            ...
            function s(J, x, y) {
                a("<span></span>").appendTo(J).addClass(x).html(v).prepend(F).css({
                    "line-height": y + "rem",
                    "font-size": f.fontsize + "rem"
                })
            }
            function D(y, x) {
                a("<span></span>").appendTo(y).addClass("circle-info-half").css("line-height", (f.dimension * x) + "rem")
            }
            function e(x) {
                a.each(w,
                function(y, J) {
