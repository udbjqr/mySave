	...
	var Stock = _react2.default.createClass({
	  ...
	  getinfo: function getinfo() {
	    ...
	    $.ajax({
	          ...
	          if (data != "" && data != null && data != undefined) {
	            ...
	            if (data.success == true) {
	              ...
	              if (data.map.list != "" && data.map.list != null && data.map.list != undefined) {
	                ...
	                this.refs.stock_cont.innerHTML = clientlist;
	              } else {
	                this.refs.stock_cont.innerHTML = "<P class='nodata'>暂时没有数据</p>";
	              }
	            }
	            //获取获取信息失败
	            if (data.success == false) {
	              ...
	              //未登录结束
	              this.refs.stock_cont.innerHTML = Datafailed;
	      ...
	      error: function (jqXHR, textStatus, errorThrown) {
	        if (this.isMounted()) {
	          this.refs.stock_cont.innerHTML = Datafailed1;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('div', { className: 'profile margint_1r ', ref: 'stock_cont' })
	    );
	  }
	});
