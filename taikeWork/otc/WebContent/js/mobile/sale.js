...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sale = _react2.default.createClass({
	  displayName: 'Sale',
	  ...
	  getinfo: function getinfo() {
	    ...
	    $.ajax({
	          ...
	          if (data != "" && data != null && data != undefined) {
	            ...
	            if (data.success == true) {
	              ...
	              if (data.map.list != "" && data.map.list != null && data.map.list != undefined) {
	                ...
	                this.refs.sale_cont.innerHTML = clientlist;
	              } else {
	                this.refs.sale_cont.innerHTML = "<P class='nodata'>暂时没有数据</p>";
	              }
	            }
	            //获取获取信息失败
	            if (data.success == false) {
	              ...
	              //未登录结束
	              this.refs.sale_cont.innerHTML = Datafailed;
	      ...
	      error: function (jqXHR, textStatus, errorThrown) {
	        if (this.isMounted()) {
	          this.refs.sale_cont.innerHTML = Datafailed1;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('div', { className: 'profile margint_1r ', ref: 'sale_cont' })
	    );
	  }
	});

	ReactDOM.render(_react2.default.createElement(Sale, null), document.getElementById('conter'));
