...
/***/ function(module, exports, __webpack_require__) {
	...
	var Informationedit = _react2.default.createClass({
	    displayName: 'Informationedit',
	    ...
	    render: function render() {
	        if (this.state.updatetype == "userInfo") {
	            //个人信息模块
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Saveuserinfo, null)
	            );
	        }
	        if (this.state.updatetype == "customerInfo") {
	            //门店客户信息模块
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Savecustomerinfo, null)
	            );
	        }
	        if (this.state.updatetype == "chainInfo") {
	            //商业客户门店客户信息模块
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Savechaininfo, null)
	            );
	        } else {
	            var showerro = showmsg({
	                ...
	                btntext: "立即返回", //按钮文字,
	                classname: "" });
	            return _react2.default.createElement('div', { dangerouslySetInnerHTML: createMarkup(showerro) });
	        }
	    }
	...
	保存用户个人信息模块
	*/
	var Saveuserinfo = _react2.default.createClass({
	    displayName: 'Saveuserinfo',
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'updateTitle', ref: 'updateTitle' },
	                    '\u4FEE\u6539',
	                    updateTitle
	                )
	            ),
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'dl',
	                        { className: 'white profile_pading infomatiodit' },
	                        _react2.default.createElement(
	                            'dd',
	                            null,
	                            _react2.default.createElement('input', { ref: 'infomationedi', type: 'text', className: 'infoedi-ipt', id: update, placeholder: "请输入你的" + updateTitle })
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { className: 'fn-btn', onTouchStart: this.infocheck },
	                    '\u786E\u8BA4'
	                )
	            )
	        );
	...
	门店客户信息模块
	*/
	var Savecustomerinfo = _react2.default.createClass({
	    displayName: 'Savecustomerinfo',
	    ...
	    //保存门店信息
	    savecustominfo: function savecustominfo() {
	        var $this = this;
	        if (this.state.isclick) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'dd',
	                            null,
	                            _react2.default.createElement('input', { ref: 'infomationedi', type: 'text', className: 'infoedi-ipt', id: update, placeholder: "请输入" + updateTitle })
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	...
	商业连锁门店信息模块
	*/
	var Savechaininfo = _react2.default.createClass({
	    displayName: 'Savechaininfo',
	    ...
	    //保存商业连锁门店信息
	    savechinainfo: function savechinainfo() {
	        var $this = this;
	        if (this.state.isclick) {
	    ...
	    /*备注签到事件*/
	    remarkChange: function remarkChange(e) {
	    ...
	    render: function render() {
	        ...
	        if (update == "chinaName") {
	            updateTitle = "连锁门店联系人";
	            inputshows = _react2.default.createElement(
	                'dd',
	                null,
	                _react2.default.createElement('input', { ref: 'infomationedi', type: 'text', className: 'infoedi-ipt', id: update, placeholder: "请输入" + updateTitle })
	            );
	        ...
	        if (update == "remark") {
	            ...
	            inputshows = this.state.signType != "signOut" ? _react2.default.createElement(
	                'dd',
	                null,
	                _react2.default.createElement(
	                    'div',
	                    { className: 'remarkshows' },
	                    remarks
	                )
	            ) : _react2.default.createElement(
	                'dd',
	                null,
	                ' ',
	                _react2.default.createElement('textarea', { onFocus: this.remarkChange, onChange: this.remarkChange, ref: 'remark', id: 'textarea', className: 'remark_input', value: this.state.remark })
	            );
	        }
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { className: 'fn-btn', ref: 'updataBtn', onTouchStart: this.infocheck },
	                    '\u786E\u8BA4'
	                )
	            )
	        );
	...
	ReactDOM.render(_react2.default.createElement(Informationedit, null), document.getElementById('conter'));
