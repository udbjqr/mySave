...
/***/ function(module, exports, __webpack_require__) {
	...
	var Planreviewmain = _react2.default.createClass({
	    displayName: 'Planreviewmain',
	    ...
	    render: function render() {
	        if (this.state.Planreviewtype == "list") {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Planreviewlist, null)
	            );
	        }
	        if (this.state.Planreviewtype == "Planreview") {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(Planreview, { dateid: this.state.dateid })
	            );
	        } else {
	            return _react2.default.createElement(
	                'div',
	...
	//审核人列表
	var Planreviewlist = _react2.default.createClass({
	    displayName: 'Planreviewlist',
	    ...
	    */
	    ...
	    toPlanreview: function toPlanreview(event) {
	        //传数据
	    ...
	    noPlanreview: function noPlanreview() {},
	    render: function render() {
	        var $this = this;

	        return _react2.default.createElement(
	            'div',
	            { className: 'planreview_main' },
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: '', id: 'planreviewlist', ref: 'planreviewlist' },
	                    this.state.json.map(function (obj, i) {
	                        var assess = obj.unaudit;
	                        var isassess = obj.unaudit > 0 ? _react2.default.createElement(
	                            'em',
	                            { className: 'reviewico' },
	                            _react2.default.createElement('i', { className: 'fa fa-circle isassess' })
	                        ) : "";
	                        var toPlanreviews = obj.unaudit > 0 ? $this.toPlanreview : $this.noPlanreview;
	                        return _react2.default.createElement(
	                            'div',
	                            { key: i, className: 'profile margint_1r' },
	                            _react2.default.createElement(
	                                'dl',
	                                { className: 'white toico', id: "customerlist" + (i + 1), 'data-id': obj.id, onClick: toPlanreviews },
	                                _react2.default.createElement(
	                                    'dt',
	                                    { className: 'planreviewdt profile_pading' },
	                                    _react2.default.createElement(
	                                        'h2',
	...
	//审核页面
	var Planreview = _react2.default.createClass({
	    displayName: 'Planreview',
	    ...
	    获取未审核计划列表
	    */
	    getPlanreviewlist: function getPlanreviewlist() {
	        var $this = this;
	        var showbox = this.refs.content;
	    ...
	    提交驳回
	    */
	    submitreject: function submitreject(flag, text) {
	        var $this = this;
	        var showbox = this.refs.content;
	        var referrer = "JavaScript:this.toreferrer()";
	    ...
	    /*  驳回 */
	    reviewback: function reviewback() {
	    ...
	    /*同意  */
	    toreviewajax: function toreviewajax() {
	        var $this = this;
	        _layer2.default.open({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { ref: 'content' },
	                _react2.default.createElement('div', { className: 'profile', id: 'planlist', ref: 'client' }),
	                _react2.default.createElement(
	                    'div',
	                    { id: 'Planreviewbtn' },
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'fn-btn review_btn', id: 'reviewbtnback', onTouchEnd: this.reviewback },
	                        '\u9A73\u56DE'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'fn-btn review_btn', id: 'toreviewbtn', onTouchEnd: this.toreviewajax },
	                        '\u540C\u610F'
	                    )
	                )
	            )
	...
	ReactDOM.render(_react2.default.createElement(Planreviewmain, null), document.getElementById('conter'));
