...
export default React.createClass({
    ...
    getlist:function(page){
      var getstrData=this.state.getstrData;
        this.ajaxFn({"controlType":"goodsSaleScoreDetail","pageSize":this.state.showLine,"pageNumber":page,"time":JSON.parse(getstrData).time,"employee_id":JSON.parse(getstrData).employee_id},function (data) {
            this.setState({
    ...
    export(){
         var getstrData=this.state.getstrData;
        this.ajaxFn({"controlType":"exportKPIScoreDetail","exportType":"goodsSaleScoreDetail","time":JSON.parse(getstrData).time,"employee_id":JSON.parse(getstrData).employee_id},function (data) {
        ...
        return (
            <QueueAnim>
                ...
                <MemberTabel
                    ...
                    titleName={["产品ID/产品名称/产品规格","客户名称","要求铺点数","实际铺点数","要求销售额","实际销售额","铺点数要求比值","铺点数实际比值","销售额要求比值","销售额实际比值"]}
                    dataKey={["goods_id/goods_name/specification","customer_name","require_build_sell_count","build_sell_count","require_money","money","build_sell_count_require_ratio","build_sell_count_actual_ratio","money_require_ratio","money_actual_ratio"]}
                />
