...
export default React.createClass({
    ...
    componentDidMount:function(){
        ...
        if(visiKey == 1){
            window.location.href = "index.html#/visitStatistics/store";
        }else{
            window.location.href = "index.html#/visitStatistics/product";
        }
    },
    ...
    render:function(){
        return (
            <QueueAnim>
                <div className="h50 border0" key="1">门店拜访统计</div>
                <Tabs type="card" onChange={this.visitChildPage}  key="2" defaultActiveKey={sessionStorage.getItem("TK_visiKey") ? sessionStorage.getItem("TK_visiKey") : '1'}>
