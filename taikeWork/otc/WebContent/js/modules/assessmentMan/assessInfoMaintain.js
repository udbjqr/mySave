...
export default React.createClass({
    ...
    getlist:function(page){
      var getstrData=this.state.getstrData;
        this.ajaxFn({"controlType":"customerSaleScoreDetail","pageSize":this.state.showLine,"pageNumber":page,"time":JSON.parse(getstrData).time,"employee_id":JSON.parse(getstrData).employee_id},function (data) {
            this.setState({
    ...
    export(){
         var getstrData=this.state.getstrData;
        this.ajaxFn({"controlType":"exportKPIScoreDetail","exportType":"customerSaleScoreDetail","time":JSON.parse(getstrData).time,"employee_id":JSON.parse(getstrData).employee_id},function (data) {
        ...
        return (
            <QueueAnim>
                ...
                <MemberTabel
                    ...
                    titleName={["checkbox","产品ID/产品名称/产品规格","门店名称","要求平均加权价","要求陈列面","要求陈列数","加权价要求比值","陈列面要求比值","陈列数要求比值","实际平均加权价比值","实际陈列面比值","实际陈列数比值"]}
                    dataKey={["goods_id/goods_name/specification","customer_name","require_weighted_price","require_display_surface","require_display_number","weighted_price_require_ratio", "display_surface_require_ratio","display_number_require_ratio","weighted_price_ratio","display_surface_ratio","display_number_ratio"]}
                />
