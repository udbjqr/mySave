<template>
    <div class="work">
        ...
        <div class="Taskagents" v-for="i in list">
            <div class="el-row">
                <div class="el-row15"><div class="grid-content bg-purple-dark" style="line-height:0.8rem;">
                ...
                <div class="el-row75"><div class="grid-content bg-purple-dark">
                 ...
                 <div class="el-row10"><div class="grid-content bg-purple-dark" style="line-height:0.8rem;"></div></div>
            </div>
        </div>
  ...
  methods:{
      ...
      todolist(){
          ...
          this.$http({
            ...
            params:{paramMap:{"controlType" : "sponsorByMeTask"}},
