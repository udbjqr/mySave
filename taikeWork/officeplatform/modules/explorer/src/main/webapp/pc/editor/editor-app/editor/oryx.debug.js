...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
    ...
    construct: function(source, modelMetaData, editorId){
		...
		if(ORYX.CONFIG.BACKEND_SWITCH) {
			...
			new Ajax.Request(ACTIVITI.CONFIG.contextRoot + '/processManger.do?paramMap={"controlType":"loadStencilset"}&version='+ Date.now(), {
	            asynchronous: false,
	            method: 'get',
...
function init() {
    ...
    // Else fetch the model from server and display editor
		...
		var modelUrl = '/processManger.do?paramMap={"controlType":"load","model_id":' + modelId + '}';
	...
	*/
    ...
    _init: function(svgDocument){
        ...
        this._paths.each((function(path){
            ...
            iPath.setAttributeNS(null, "stroke", "#6d26ff");
